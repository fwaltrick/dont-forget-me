...
const deleteStuff = document.querySelector( '[data-delete-stuff]' );
...
// setting local storage to save list of tasks and 
...
function render() {
  ...
  if ( selectedListId === null ) {
    ...
    deleteStuff.style.display = 'none';
  } else {
    listDisplayContainer.style.display = '';
    deleteStuff.style.display = '';
